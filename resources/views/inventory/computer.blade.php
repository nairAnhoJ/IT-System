<x-app-layout>
    ...
    <div style="height: calc(100vh - 65px);" class="p-3 text-gray-200 w-screen">
        ...
        <div class="grid grid-cols-2 mb-0 h-10">
            <div class="h-8">
                <button type="button" class="h-full text-white focus:ring-4 font-medium rounded-lg text-sm px-10 pt-1 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">Add Item</button>
            </div>
            <div class="flex gap-x-3 h-8">
                <div class="w-1/3">
                    <select id="countries" class="border text-sm rounded-lg block px-2.5 pt-1 pb-0 w-full h-full bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                        <option selected value="">All Sites</option>
            ...
            <table class="table-fixed min-w-full text-sm text-left text-gray-400">
                <thead class="relative top-0 text-xs uppercase bg-gray-600 text-gray-400 border-x-8 border-gray-600">
                    <tr class="bg-gray-600 sticky top-0">
                        <th id="thl" scope="col" class="w-10 sticky top-0 py-2 px-3 text-center">
                            #
                        </th>
                        <th scope="col" class="sticky top-0 py-2 px-3 text-center">
                            TYPE
                        </th>
                        ...
                        <th id="thr" scope="col" class="sticky top-0 py-2 px-3 text-center">
                            ACTION
                        </th>
                    </tr>
                </thead>
