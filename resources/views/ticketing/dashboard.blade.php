                    ...
                    <form id="statusUpdateForm" enctype="multipart/form-data" action="{{ route('ticket.update') }}" method="POST" class="relative text-sm bg-gray-700 rounded-lg shadow">
                        <!-- Modal header -->
                            <div class="flex items-start justify-between p-4 border-b border-gray-600 rounded-t">
                                <h3 class="text-lg font-semibold leading-5 tracking-wide text-white">
                                    @csrf
                        ...
                        <div class="p-3">
                            ...
                            {{-- Ticket Info --}}
                                ...
                                <div id="ticketDesc" class="mb-2 max-h-[180px] text-sm leading-relaxed text-gray-300 whitespace-pre-line overflow-y-auto"></div>
                            {{-- Ticket Info --}}
                            ...
                            {{-- Ticket Update --}}
                                <div id="ticketUpdateDiv">
                                    ...
                                    <textarea disabled id="ticketUpdateTextArea" style="resize: none;" rows=3 cols=50 maxlength=1000 class="UpdateDivAutoHeight block max-h-[160px] p-2.5 w-full text-sm rounded-lg bg-gray-700 border-gray-700 placeholder-gray-400 text-white">${update}</textarea>
                                </div>
                            ...
                            {{-- Ticket Resolution Input --}}
                                @if (auth()->user()->dept_id == $deptInCharge)
                                    <div id="ticketResolutionInputDiv">
                                        ...
                                        <textarea style="resize: none;" id="ticketResolutionInput" name="ticketResolution" rows=1 cols=50 maxlength=1000 class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"></textarea>
                                        <div class="mt-5">
        ...
        <!--  Controls  -->
            <div class="grid h-10 grid-cols-3 mb-0">
                <div class="h-8 col-span-2">
                    {{-- @if ($userDept != 'IT') --}}
                    @if (auth()->user()->dept_id != $deptInCharge)
                        <a href="http://192.168.20.110:1111/login" target type="button" class="w-40 mb-2 mr-2 text-sm font-medium leading-8 text-center text-white bg-blue-600 rounded-lg focus:ring-4 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">Create Ticket</a>
