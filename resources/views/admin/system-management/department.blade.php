  ...
  <div style="height: calc(100vh - 65px);" class="p-3 text-gray-200 w-screen">
    <h1 class="mb-3 font-extrabold leading-none text-3xl text-blue-500 tracking-wide">DEPARTMENT</h1>
        ...
        {{-- ================================= ADD / EDIT MODAL ================================= --}}
            ...
            <div id="departmentModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto h-modal h-full">
                <div class="relative w-full h-full max-w-2xl md:h-auto">
                    <!-- Modal content -->
                    <form id="deptForm" action="" method="POST" class="relative rounded-lg shadow bg-gray-700 text-sm">
                        @csrf
                        <!-- Modal header -->
                        ...
                        <div class="px-6 pb-7 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="deptName" name="name" class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
        ...
        {{-- ================================= DELETE MODAL ================================= --}}
            ...
            <!-- ========================================================= Main modal ========================================================= -->
            <div id="deptDeleteModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto h-modal h-full">
                <div class="relative w-full h-full max-w-2xl md:h-auto">
                    <!-- Modal content -->
        ...
        <div class="grid grid-cols-3 mb-0 h-10">
            <div class="h-8 col-span-2">
                <button class="deptAdd h-full text-white font-medium rounded-lg text-sm px-10 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none">Add</button>
              ...
              <tbody id="departmentTableBody" style="max-height: calc(100% - 126px);">
                ...
                @foreach ($depts as $dept)
                    <tr class="bg-gray-800 {{ $x>1 ? 'border-t' : '' }} border-gray-700 hover:bg-gray-700">
                        ...
                        <td class="py-3 px-6 text-center whitespace-nowrap">
                            <a data-id="{{ $dept->id }}" data-name="{{ $dept->name }}" class="deptEdit mr-2 text-blue-500 cursor-pointer">EDIT</a>|<a data-id="{{ $dept->id }}" data-name="{{ $dept->name }}" class="btnDeptDelete ml-2 text-red-500 cursor-pointer">DELETE</a>
                        </td>
                    </tr>
                @endforeach
              </tbody>
