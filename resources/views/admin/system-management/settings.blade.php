    ...
    <div style="height: calc(100vh - 65px);" class="p-6 text-gray-200 w-screen">
        ...
        <form id="smtpForm" action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <input required type="text" id="hostServer" name="hostServer" value="{{ $settings->smtp_server }}" {{ ($settings->smtp_is_activated == 1) ? '' : 'disabled'}} class="disabled:opacity-40 disabled:pointer-events-none block w-1/3 p-2 border rounded-lg sm:text-xs bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <input type="password" id="password" name="password" value="" {{ ($settings->smtp_is_activated == 1) ? '' : 'disabled'}} class="disabled:opacity-40 disabled:pointer-events-none block w-1/3 p-2 border rounded-lg sm:text-xs bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="mb-2">
                ...
                <input required type="text" id="name" name="name" value="{{ $settings->smtp_name }}" {{ ($settings->smtp_is_activated == 1) ? '' : 'disabled'}} class="disabled:opacity-40 disabled:pointer-events-none block w-1/3 p-2 border rounded-lg sm:text-xs bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="mb-3">
                ...
                <input required type="text" id="port" name="port" value="{{ $settings->smtp_port }}" {{ ($settings->smtp_is_activated == 1) ? '' : 'disabled'}} class="disabled:opacity-40 disabled:pointer-events-none block w-1/3 p-2 border rounded-lg sm:text-xs bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div>
