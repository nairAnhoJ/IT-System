<x-app-layout>
    ...
    <div style="height: calc(100vh - 65px);" class="p-3 text-gray-200 w-screen">
        <h1 class="mb-3 font-extrabold leading-none text-3xl text-blue-500 tracking-wide">SITES</h1>
                    ...
                    <div class="relative w-full h-full max-w-2xl md:h-auto">
                        ...
                        <form id="itemTypeForm" action="" method="POST" class="relative rounded-lg shadow bg-gray-700 text-sm">
                            ...
                            <div class="px-6 pb-7 space-y-6">
                                ...
                                <div>
                                    <label for="itemTypeName" class="block mb-2 text-sm font-medium text-white">Site / Branch Name</label>
            ...
            {{-- ================================= DELETE MODAL ================================= --}}
                ...
                <div id="itemTypeDeleteModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto h-modal h-full">
                    <div class="relative w-full h-full max-w-2xl md:h-auto">
                        <!-- Modal content -->
                        <form action="{{ route('site.delete') }}" method="POST" class="relative rounded-lg shadow bg-gray-700 text-sm">
                            @csrf
                            <!-- Modal header -->
                            <div class="flex items-center justify-between px-4 py-3 border-b rounded-t border-gray-600">
                            ...
                            <div class="px-6 pb-7 space-y-6">
                                ...
                                <div>
                                    <label for="delItemTypeName" class="block mb-2 text-sm font-medium text-white">Are you sure you want to delete this Site / Branch?</label>
                ...
                <tbody id="departmentTableBody" style="max-height: calc(100% - 126px);">
                    ...
                    @foreach ($sites as $site)
                        <tr class="bg-gray-800 {{ $x>1 ? 'border-t' : '' }} border-gray-700 hover:bg-gray-700">
                            ...
                            <td class="py-3 px-6 text-center whitespace-nowrap">
                                <a data-id="{{ $site->id }}" data-name="{{ $site->name }}" class="itemTypeEdit mr-2 text-blue-500 cursor-pointer">EDIT</a>|<a data-id="{{ $site->id }}" data-name="{{ $site->name }}" class="btnItemTypeDelete ml-2 text-red-500 cursor-pointer">DELETE</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
