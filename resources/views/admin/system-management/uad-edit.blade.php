    ...
    <div style="height: calc(100vh - 65px);" class="p-6 text-gray-200 w-screen overflow-x-hidden overflow-y-auto">
        ...
        <form action="" id="frmAUD" method="post">
            ...
            <div class="mt-10 mb-5">
                <textarea id="uad" style="height: 34px;" name="aud" class="block p-2.5 w-full rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 resize-none leading-4 text-sm">{{ $settings->user_agreement_device }}</textarea>
            </div>
